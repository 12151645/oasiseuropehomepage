      ...
      <div className="section-padding max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <a
            ...
            className="inline-flex items-center gap-3 px-8 py-3 bg-capital text-capital-foreground font-body text-sm uppercase tracking-[0.15em] hover:bg-capital-light transition-colors"
          >
            Contact Us
            <ArrowRight size={16} />
          </a>
          <button className="px-8 py-3 border border-foreground/30 text-foreground font-body text-sm uppercase tracking-[0.15em] hover:border-foreground/60 transition-colors">
