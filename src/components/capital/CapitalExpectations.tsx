...
const pillars = [
  ...
  },
  {
    ...
    description:
      "Regular progress updates, construction reporting, financial summaries, and clear timeline communication. Transparency is fundamental to the structure.",
  },
  {
    icon: Clock,
    ...
    <section ref={ref} className="py-24 md:py-32 bg-background">
      <div className="section-padding">
        <div className="text-center mb-16 md:mb-20">
          ...
          <h2 className="heading-lg">What Investors Can Expect</h2>
        </div>
