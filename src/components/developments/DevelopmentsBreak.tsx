...
const DevelopmentsBreak = () => {
  ...
  return (
    <section ref={ref} className="bg-background py-24 md:py-32 overflow-hidden">
      ...
      >
        <p className="label-sm text-muted-foreground mb-6">Our Approach</p>
        <p className="font-display text-2xl md:text-4xl font-light text-foreground leading-relaxed max-w-2xl italic">
