      ...
      <div className="relative z-10 section-padding">
        <div className="text-center mb-16 md:mb-20">
          ...
          <h2 className="heading-lg text-sand">
            ...
            <br />
            <em className="italic font-light">Uncompromised Standards</em>
          </h2>
        </div>
          ...
          {pillars.map((pillar, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-display text-xl font-medium mb-4 text-sand">
                  {pillar.title}
                </h3>
                <p className="text-sm text-sand/60 font-light leading-relaxed">
                  {pillar.description}
                </p>
              </div>
            );
