...
import managementVilla from "@/assets/management-villa.jpg";

const stats = [
  { value: "45+", label: "Luxury Properties Managed" },
  { value: "8", label: "Years of Operations" },
  { value: "32%", label: "Avg. Annual Revenue Growth" },
];
    ...
    <section ref={ref} className="bg-background">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[70vh]">
        ...
        <div className="relative min-h-[400px] lg:min-h-full overflow-hidden">
          <img
            src={managementVilla}
            alt="Luxury Marbella villa with pool"
