  ...
  return (
    <footer className="bg-foreground text-primary-foreground">
      ...
      <div className="border-b border-primary-foreground/10">
        <div className="section-padding py-14 md:py-28 grid grid-cols-1 md:grid-cols-[1.3fr_1fr] gap-10 md:gap-20 md:items-end">
          <div>
            <p className="text-[0.65rem] uppercase tracking-[0.24em] text-accent mb-5 md:mb-6 flex items-center gap-3">
              <span className="h-px w-8 bg-accent/60" />
              Private Office
            </p>
            <h2 className="font-display text-[2rem] leading-[1.12] md:text-5xl lg:text-6xl font-light md:leading-[1.1] tracking-[-0.015em]">
              Where discerning capital meets{" "}
              <em className="italic font-normal text-accent">considered design.</em>
            </h2>
            <p className="mt-5 md:mt-6 text-sm md:text-base text-primary-foreground/55 font-light max-w-md leading-relaxed">
          ...
          <div className="flex flex-col gap-3">
            <EnquiryDialog
              trigger={
                <button className="group inline-flex items-center justify-between gap-4 bg-accent text-foreground px-6 md:px-7 min-h-[56px] py-4 md:py-5 text-[0.72rem] uppercase tracking-[0.18em] font-medium hover:bg-primary-foreground transition-colors duration-300 w-full">
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-2 border border-primary-foreground/25 text-primary-foreground px-4 min-h-[52px] py-4 text-[0.7rem] uppercase tracking-[0.16em] hover:border-accent hover:text-accent transition-colors duration-300"
              >
                <MessageCircle size={13} /> WhatsApp
              </a>
              <SubscribeDialog
                trigger={
                  <button className="inline-flex items-center justify-center gap-2 border border-primary-foreground/25 text-primary-foreground px-4 min-h-[52px] py-4 text-[0.7rem] uppercase tracking-[0.16em] hover:border-accent hover:text-accent transition-colors duration-300 w-full">
                    Subscribe
                  </button>
                }
              />
